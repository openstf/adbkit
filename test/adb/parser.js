...
describe('Parser', function() {
  ...
  describe('end()', () =>
    ...
    it('should end the stream and consume all remaining data', function(done) {
...
before enough bytes can be read', function(done) {
  ...
  describe('readByteFlow(maxHowMany, targetStream)', function() {
    ...
    it('should progress with new/partial chunk until maxHowMany', function(done) {
      const stream = new Stream.PassThrough
      const parser = new Parser(stream)
      const target = new Stream.PassThrough
      const spy = Sinon.spy()
    ...
    return it('should resolve on last chunk', function(done) {
      const stream = new Stream.PassThrough
      const parser = new Parser(stream)
      const target = new Stream.PassThrough
      const spy = Sinon.spy()
...
before a line is found', function(done) {
  ...
  describe('raw()', () =>
    ...
    it('should return the resumed raw stream', function(done) {
      const stream = new Stream.PassThrough
      const parser = new Parser(stream)
  ...
  return describe('unexpected(data, expected)', () =>
    ...
    it('should reject with Parser.UnexpectedDataError', function(done) {
      const stream = new Stream.PassThrough
      const parser = new Parser(stream)
